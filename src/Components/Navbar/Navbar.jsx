...
const Navbar = () => {
  ...
  const navlinks = (
    <>
      <li className="text-sm title-font my-2 lg:text-black font-bold text-black tracking-widest uppercase">
        ...
        <div className="navbar-start ">
          <div className="dropdown">
            <label tabIndex={0} className="btn btn-ghost lg:hidden">
              <TfiMenu className="text-black font-semibold text-2xl"></TfiMenu>
            </label>
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow uppercase bg-base-100 rounded-box w-52"
            >
              {navlinks}
            </ul>
          </div>
          <div className="flex flex-col justify-center items-center">
            <img
              className="w-20"
              src="https://i.ibb.co/R68BPTx/Untitled-removebg-preview-1.png"
              alt="logo"
            />
          </div>
        </div>
